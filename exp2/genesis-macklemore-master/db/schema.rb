...
ActiveRecord::Schema.define(version: 2018_12_21_063727) do
  ...
  create_table "articles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["design_id"], name: "index_articles_on_design_id"
    t.index ["product_id"], name: "index_articles_on_product_id"
    t.index ["technical_id"], name: "index_articles_on_technical_id"
  end
