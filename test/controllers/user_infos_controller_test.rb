...
class UserInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post user_infos_url, params: { user_info: { alt_number: @user_info.alt_number, birthday: @user_info.birthday, current_office: @user_info.current_office, designation: @user_info.designation, extension: @user_info.extension, image: @user_info.image, mob_number: @user_info.mob_number, name: @user_info.name, permanent_office: @user_info.permanent_office, user_id: @user_info.user_id } }
    end
  ...
  test "should update user_info" do
    patch user_info_url(@user_info), params: { user_info: { alt_number: @user_info.alt_number, birthday: @user_info.birthday, current_office: @user_info.current_office, designation: @user_info.designation, extension: @user_info.extension, image: @user_info.image, mob_number: @user_info.mob_number, name: @user_info.name, permanent_office: @user_info.permanent_office, user_id: @user_info.user_id } }
