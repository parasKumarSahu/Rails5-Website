...
class InstallationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create installation" do
    assert_difference('Installation.count') do
      post installations_url, params: { installation: { fabrication: @installation.fabrication, product_id: @installation.product_id, safety: @installation.safety } }
    end
  ...
  test "should update installation" do
    patch installation_url(@installation), params: { installation: { fabrication: @installation.fabrication, product_id: @installation.product_id, safety: @installation.safety } }
