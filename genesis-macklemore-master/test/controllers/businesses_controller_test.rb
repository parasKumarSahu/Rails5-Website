...
class BusinessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post businesses_url, params: { business: { body: @business.body, product_id: @business.product_id } }
    end
  ...
  test "should update business" do
    patch business_url(@business), params: { business: { body: @business.body, product_id: @business.product_id } }
